...
драматичный synthwave динамически реагирует на скорость, комбо, VPN-буст, капчу и смерть.
...
| Ключ | Назначение |
|------|------------|
| `STORE_URL` | платёжный фронт CTA «Включить ЮБуст» (`https://uboost.site/`) |
| `GAME_URL`  | ссылка на игру для шеринга |
| `TG_BOT_URL`| опц. ссылка на бота |
| `PROMO` | реальный код скидки из биллинга; пустой `code` скрывает оффер |
| `RULESET_VERSION` | сезон рейтинга после изменений баланса |
...
## 📊 Прогресс, дашборд и общий рейтинг

Кнопка 🏆 показывает личные показатели и подтверждённый общий рейтинг. Сначала
виден топ-5; остальное раскрывается кнопкой. Без сети игра честно переключается
на локальную доску. Production Node + SQLite API и Telegram-бот описаны в
[`backend/`](backend/README.md). Промокод сейчас скрыт до создания реальной
скидки в биллинге.
